...
→ Planner 读取 industry_knowledge/{industry}.json
→ LLM 或模板生成 planning.json
...
| 行业知识库 | `backend/app/industry_knowledge.py`、`industry_knowledge/*.json` |
